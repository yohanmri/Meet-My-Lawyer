...
const LawyerDashboard = () => {
    ...
    const { dToken, dashData, setDashData, getDashData, completeAppointment, cancelAppointment } = useContext(LawyerContext)
    ...
    return dashData && (
        /* if only we have the dash data we will display the UI*/
        <div className='m-5'>
