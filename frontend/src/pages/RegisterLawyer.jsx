            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        onChange={(e) => handleInputChange('application_address', e.target.value)}
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 resize-none"
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-6">
                <div className="border border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Profile Picture</h3>
                ...
                <div className="border border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">License Certificate</h3>
                ...
                <div className="border border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors duration-200">
                    <FileText className="mx-auto h-12 w-12 text-gray-400" />
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Birth Certificate</h3>
                ...
                <div className="border border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors duration-200">
                    <FileText className="mx-auto h-12 w-12 text-gray-400" />
                    <h3 className="mt-2 text-sm font-medium text-gray-900">Professional Certificates</h3>
                    ...
                    <div className="p-8">
                        ...
                        <div className="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
                            <button
                                ...
                                className={`flex items-center px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 ${currentStep === 0
                            ...
                            {currentStep < steps.length - 1 ? (
                                <button
                                    onClick={nextStep}
                                    className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-all duration-200"
                                >
                                    Next
                                ...
                                <button
                                    ...
                                    className="flex items-center px-6 py-2 bg-green-600 text-white rounded-md text-sm font-bold hover:bg-green-700 transition-all duration-200"
                                >
                                    Submit Application
                                </button>
                            )}
